...
public class Jardin extends Applet
{
    ...
    // 3B - Usando synchronized
    /*
     * Comento las líneas del Alg. de Peterson
     * y usamos synchronized. Es más fácil con synchronized
     */
...
//     volatile int turno=0;
    ...
    // Añadimos synchronized al método
    synchronized void incrementa(int id)
    {
        // Levanta bandera
